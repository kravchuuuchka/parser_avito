...
def _run(db: str) -> None:
    ...
    ad_closed = Ad(
        id="333",
        title="Котик закрытый",
        price=100.0,
        address="Новосибирск",
        description="Уже продан",
        published_on=date(2026, 3, 1),
        views=1,
        url="https://avito.ru/item_333",
        status=0,
        city="новосибирск",
        query="котик",
    )
    ...
    ad_spb = Ad(
        id="444",
        title="Котик петербургский",
        price=200.0,
        address="СПб",
        description="Пушистый",
        published_on=date(2026, 3, 3),
        views=3,
        url="https://avito.ru/item_444",
        status=1,
